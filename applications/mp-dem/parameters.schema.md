# mp-dem: Parameter description

## Contents

- [`base`](#base)
- [`spherical particle contact force`](#spherical-particle-contact-force)
...
<a id="spherical-particle-contact-force"></a>
## `🔷 spherical particle contact force`
...
| [`particle-particle contact`](#spherical-particle-contact-force-particle-particle-contact) | `object` |  | [See table](#spherical-particle-contact-force-particle-particle-contact) |

<a id="spherical-particle-contact-force-particle-particle-contact"></a>
### `spherical particle contact force: particle-particle contact`
...
| `gravity constant` | `number` | `9.81` | Gravitational acceleration constant used for computing the gravitational force acting on the obstacles. |
