...
namespace MeltPoolDG::Simulation::StefansProblem1WithFlowAndHeat
{
  ...
  namespace AnalyticalSolution
  {
    ...
    double
    compute_beta(const MeltPoolCaseParameters<number> &parameters, const double T_wall)
    {
    ...
    template <typename number>
    double
    analytical_interface_location(const MeltPoolCaseParameters<number> &parameters,
                                  const double                          T_wall,
                                  const double                          time,
    ...
    template <typename number>
    double
    analytical_temperature(const MeltPoolCaseParameters<number> &parameters,
                           const double                          T_wall,
                           const double                          time,
                           const double                          x,
                           const double                          beta = -1.0)
