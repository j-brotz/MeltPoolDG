...
namespace MeltPoolDG::Simulation::RadiativeTransport
{
  ...
  template <int dim>
  SimulationRadTrans<dim>::SimulationRadTrans(std::string    parameter_file,
                                              const MPI_Comm mpi_communicator)
    : MeltPoolDG::RadiativeTransport::RadiativeTransportCase<dim>(parameter_file, mpi_communicator)
  ...
  template <int dim>
  bool
  SimulationRadTrans<dim>::add_simulation_specific_parameters(dealii::ParameterHandler &prm)
  {
  ...
  template <int dim>
  void
  SimulationRadTrans<dim>::create_spatial_discretization()
  {
  ...
  template <int dim>
  void
  SimulationRadTrans<dim>::set_boundary_conditions()
  {
  ...
  template <int dim>
  void
  SimulationRadTrans<dim>::set_field_conditions()
  {
