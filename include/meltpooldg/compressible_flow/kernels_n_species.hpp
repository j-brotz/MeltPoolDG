...
namespace MeltPoolDG::CompressibleFlow
{
  ...
  struct NSpeciesConvectiveFluxImpl
  {
  ...
  struct NSpeciesConvectiveFluxImpl<dim, 1, number, Value, Flux>
  {
  ...
  using NSpeciesConvectiveFlux =
    typename NSpeciesConvectiveFluxImpl<dim, n_species, number, Value, Flux>::type;
  ...
  template <int dim,
            ...
            typename Gradient,
            typename Flux>
  struct NSpeciesDiffusiveFluxImpl
  {
  ...
  struct NSpeciesDiffusiveFluxImpl<dim, 1, number, Value, Gradient, Flux>
  {
  ...
  using NSpeciesDiffusiveFlux =
    typename NSpeciesDiffusiveFluxImpl<dim, n_species, number, Value, Gradient, Flux>::type;
