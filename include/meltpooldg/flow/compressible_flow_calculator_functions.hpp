/**
 * @brief Collection of calulator functions for the compressible Navier-Stokes equations.
 */
...
namespace MeltPoolDG::Flow
{
  ...
  struct CompressibleFlowCalculators
  {
    ...
    explicit CompressibleFlowCalculators(const CompressibleFlowData &comp_flow_data)
      : comp_flow_data(comp_flow_data)
    {}
  ...
  inline DEAL_II_ALWAYS_INLINE //
    dealii::Tensor<2, dim, dealii::VectorizedArray<number>>
    CompressibleFlowCalculators<dim, number>::calculate_grad_velocity(
      const ConservedVariablesType     &conserved_variables,
      const ConservedVariablesGradType &grad_conserved_variables)
  {
    const dealii::VectorizedArray<number> inverse_density =
  ...
  inline DEAL_II_ALWAYS_INLINE //
    dealii::Tensor<1, dim, dealii::VectorizedArray<number>>
    CompressibleFlowCalculators<dim, number>::calculate_grad_T(
      const ConservedVariablesType     &conserved_variables,
      const ConservedVariablesGradType &grad_conserved_variables) const
  {
  ...
  template <int dim, typename number>
  inline DEAL_II_ALWAYS_INLINE //
    typename CompressibleFlowCalculators<dim, number>::ConservedVariablesType
    CompressibleFlowCalculators<dim, number>::contract_tensor_with_normal(
      const ConservedVariablesGradType                              &grad,
      const dealii::Tensor<1, dim, dealii::VectorizedArray<number>> &normal) const
  {
  ...
  DEAL_II_ALWAYS_INLINE //
    typename CompressibleFlowCalculators<dim, number>::ConservedVariablesType
    CompressibleFlowCalculators<dim, number>::contract_average_tensor_with_normal(
      const ConservedVariablesGradType                              &grad_m,
      const ConservedVariablesGradType                              &grad_p,
      const dealii::Tensor<1, dim, dealii::VectorizedArray<number>> &normal) const
  {
  ...
  template <int dim, typename number>
  inline DEAL_II_ALWAYS_INLINE //
    typename CompressibleFlowCalculators<dim, number>::ConservedVariablesGradType
    CompressibleFlowCalculators<dim, number>::calculate_convective_flux(
  ...
  inline DEAL_II_ALWAYS_INLINE //
    typename CompressibleFlowCalculators<dim, number>::ConservedVariablesType
    CompressibleFlowCalculators<dim, number>::calculate_convective_numerical_flux(
      const ConservedVariablesType                                  &u_m,
      const ConservedVariablesType                                  &u_p,
      const dealii::Tensor<1, dim, dealii::VectorizedArray<number>> &normal) const
  {
    ...
    if (comp_flow_data.numerical_flux_type == "lax_friedrichs_modified")
      {
        const auto lambda =
    ...
    else if (comp_flow_data.numerical_flux_type == "lax_friedrichs_exact")
      {
        const auto lambda =
    ...
    else if (comp_flow_data.numerical_flux_type == "harten_lax_vanleer")
      {
  ...
  inline DEAL_II_ALWAYS_INLINE //
    dealii::Tensor<2, dim, dealii::VectorizedArray<number>>
    CompressibleFlowCalculators<dim, number>::calculate_viscous_stress_tensor(
      const dealii::Tensor<2, dim, dealii::VectorizedArray<number>> &grad_u) const
  {
  ...
  inline DEAL_II_ALWAYS_INLINE //
    typename CompressibleFlowCalculators<dim, number>::ConservedVariablesGradType
    CompressibleFlowCalculators<dim, number>::calculate_viscous_flux(
      const ConservedVariablesType     &conserved_variables,
      const ConservedVariablesGradType &grad_conserved_variables) const
  {
    const dealii::Tensor<1, dim, dealii::VectorizedArray<number>> velocity =
  ...
  inline DEAL_II_ALWAYS_INLINE //
    typename CompressibleFlowCalculators<dim, number>::ConservedVariablesType
    CompressibleFlowCalculators<dim, number>::calculate_viscous_numerical_flux(
      const ConservedVariablesType                                  &u_m,
      const ConservedVariablesType                                  &u_p,
      const ConservedVariablesGradType                              &grad_u_m,
      const ConservedVariablesGradType                              &grad_u_p,
  ...
  template <int dim, typename number>
  inline DEAL_II_ALWAYS_INLINE //
    std::pair<typename CompressibleFlowCalculators<dim, number>::ConservedVariablesGradType,
              typename CompressibleFlowCalculators<dim, number>::ConservedVariablesGradType>
    CompressibleFlowCalculators<dim, number>::calculate_viscous_numerical_flux_gradient(
      const ConservedVariablesType                                  &u_m,
      const ConservedVariablesType                                  &u_p,
      const dealii::Tensor<1, dim, dealii::VectorizedArray<number>> &normal) const
  {
