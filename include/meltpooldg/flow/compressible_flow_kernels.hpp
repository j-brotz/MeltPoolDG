...
namespace MeltPoolDG::Flow
{
  ...
  struct CompressibleConvectiveFlux
  {
    ...
    {
      DofStateViewType conserved_variables_view(conserved_variables,
                                                material.eos_data.type,
                                                material);
    ...
    {
      DofStateViewType u_m_view(u_m, material.eos_data.type, material);
      DofStateViewType u_p_view(u_p, material.eos_data.type, material);
  ...
  struct CompressibleDiffusiveFlux
  {
    ...
    {
      DofValueAndGradientStateViewType conserved_variables_view(u,
                                                                grad_u,
                                                                material.eos_data.type,
                                                                material);
