...
namespace MeltPoolDG
{
  ...
  public:
     ...
     */
    void
    add_wall(std::unique_ptr<dealii::Function<dim>> &&wall_signed_distance_function);
  ...
  private:
    ...
    /// ids.
    mutable std::map<int, std::map<int, dealii::Tensor<1, dim, number>>>
      previous_tangential_gaps_with_walls;
