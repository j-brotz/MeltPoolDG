...
old_parameter_names = [
    ...
    ["laser", "laser gauss absorptivity gas"], # and ["laser", "analytical", "absorptivity gas"],
    ["laser", "laser gauss absorptivity liquid"], # and ["laser", "analytical", "absorptivity liquid"],
    ["laser", "laser do move"],
    ["laser", "laser scan speed"],
    ["laser", "laser gauss laser beam radius"],# and ["laser", "laser gusarov laser beam radius"],
