...
namespace MeltPoolDG::Heat
{
  ...
  template <int dim>
  void
  LaserHeatSourceUniform<dim>::compute_interfacial_heat_source(
            ...
            for (const auto q : heat_source_eval.quadrature_point_indices())
              {
                ...
                heat_source_vector_local[q] = local_compute_interfacial_heat_source(
                  laser_power_density, normal_at_q[q], delta_value, ls_heaviside_at_q[q]);
              }
