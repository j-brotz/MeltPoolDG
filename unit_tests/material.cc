...
void
print_material_parameter_values(const MaterialParameterValues<double, double> &values)
{
...
void
print_material_parameter_values(
  const MaterialParameterValues<VectorizedArray<double>, double> &values)
{
