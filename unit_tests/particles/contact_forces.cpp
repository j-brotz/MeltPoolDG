...
namespace
{
  ...
  TEST_F(ContactForceFixture, NormalParticleParticleContactSameRadiusSameDensity)
  {
    ...
    // - Two particles are in contact.
    // - Particles have the same radius and densities.
  ...
  TEST_F(ContactForceFixture, NormalParticleParticleContactSameRadiusDifferentDensity)
  {
    // This test verifies particle–particle contact behavior under the following conditions:
    // - Two particles are in contact.
    // - Particles have the same radius but different densities.
    // - Particles move along the line of centers, producing a purely normal contact force.
    using particle_id_type = int;
  ...
  TEST_F(ContactForceFixture, NormalParticleParticleContactDifferentRadius)
  {
    // This test verifies particle–particle contact behavior under the following conditions:
    // - Two particles are in contact.
    // - Particles have different radii but the same density.
    // - Particles move along the line of centers, producing a purely normal contact force.
    using particle_id_type = int;
  ...
  TEST_F(ContactForceFixture, NormalParticleParticleAngledContact)
  {
    ...
    // - Two particles are in contact.
    // - Particles have different radii but the same density.
    // - Particles move along the line of centers, producing a purely normal contact force. The line
    //   of center does not align with any coordinate axis.
    using particle_id_type = int;
  ...
  {
    // This test verifies particle–particle contact behavior under the following conditions:
    // - Three particles are in contact.
    // - Particles have different radii but the same density.
    // - Particles move along the line of centers, producing a purely normal contact force.
    using particle_id_type = int;
