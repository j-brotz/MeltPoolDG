# Creates MPI-enabled verification test executables using GoogleTest. Each source file 
...
#
# Example:
#   mpdg_setup_mpi_verification_tests(
#     N_MPI_PROCESSES 4
#     TEST_SOURCE_FILES
#       test_1.cpp
#       test_2.cpp
#   )
function(mpdg_setup_mpi_verification_tests)
    set(options "")
    ...
    if(NOT ARG_TEST_SOURCE_FILES)
        message(WARNING "An empty list of test source files was provided to mpdg_setup_mpi_verification_tests. This call will therefore not create any tests and is obsolete.")
    endif()
    ...
    foreach(test_src ${ARG_TEST_SOURCE_FILES})
        ...
        add_executable(${test_target} ${CMAKE_SOURCE_DIR}/verification/test_utils/gtest_mpi_main.cpp ${test_src})
        ...
        set(mpi_arguments
            ...
            --gtest_output=xml:verification_reports/${test_target}_report.xml)
        ...
        set_property(TEST ${test_target} PROPERTY LABELS VerificationTest MPI)
